const CACHE_NAME = "spin-brickell-v168";
const TILE_VERSION = "168";
...
const APP_ASSETS = [
  "./",
  "./index.html",
  "./vendor/leaflet/leaflet.css?v=168",
  "./vendor/leaflet/leaflet.js?v=168",
  ...
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then(async (cache) => {
        ...
        await cacheRoutingGraphChunks(cache);
      })
